...
ll solve(int ind,vi &v,ll sum1,ll sum2){
    if(ind==v.size()) return (sum1-sum2)>0?sum1-sum2:sum2-sum1;
    else return min(solve(ind+1,v,sum1+v[ind],sum2),solve(ind+1,v,sum1,sum2+v[ind]));
}
